...
FAULT_REPLAY_UNSUPPORTED_DRAW_PILE_CONSUMPTION = "replay_unsupported_draw_pile_consumption"
FAULT_REPLAY_UNSUPPORTED_PINNED_DRAW_MATERIALIZATION = "replay_unsupported_pinned_draw_materialization"
